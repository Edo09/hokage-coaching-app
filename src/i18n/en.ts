export default {
  ...
  tabs: {
    ...
    routines: "Routines",
    program: "Program",
    // The Nutrition tab replaced the old Meals tab; the diary lives inside it.
    nutrition: "Nutrition",
    progress: "Progress",
    profile: "Profile",
  },
  ...
  program: {
    ...
    weeksCount: "{{count}}-week block",
    startsOn: "Starts {{date}}",
    notStartedHint: "This block starts on {{date}}.",
    weekN: "Week {{n}}",
    ...
    deload: "Deload",
    loadLabel: "Load {{load}}",
    setsOverride: "{{sets}} sets this week",
    coachNotes: "Coach notes",
    tempo: "Tempo",
    progression: "Progression",
    notes: "Notes",
    dayN: "DAY {{n}}",
    watchDemo: "Watch demo: {{name}}",
  ...
  routines: {
    ...
    noExerciseResults: "No exercises match your search",
  ...
  coach: {
    ...
    noProgramHint: "Your coach will assign your training program — it'll show up here.",
  ...
  nutritionPlan: {
    ...
    segmentDiary: "Diary",
    noPlanTitle: "No nutrition plan",
    noPlanHint: "Your coach hasn't assigned one yet. In the meantime you can log your meals in the diary.",
    ...
    carbs: "C",
    fat: "F",
    noTarget: "Your coach set no macro targets.",
    optional: "optional",
    register: "Log to my diary",
    registerHint: "Opens the log with the food filled in. Take the photo and the app works out the macros.",
    restDaySubstitution: "On rest days",
    coachNotes: "Coach notes",
    slotHiddenToday: "Not for today",
  },
  ...
  supplements: {
    ...
    tierBaseHint: "Required",
    tierConditionalHint: "As tolerated",
    tierOptionalHint: "Lower priority",
    scheduleTitle: "Schedule",
    dose: "Dose",
    purpose: "Purpose",
    timing_wake: "On waking",
    timing_breakfast: "Breakfast",
    timing_pre_workout: "Pre-workout",
    timing_intra_workout: "During workout",
